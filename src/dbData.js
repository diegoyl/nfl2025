...
const gameDict = [
    ...
    {'game_id':'g5','team_code':{'home':'TB','away':'WAS'},'team_name':{'home':'BUCCANEERS','away':'COMMANDERS'},'ML':{'home':77,'away':123},'TD':{'home':[['RB','B.Irving',17],['WR','M.Evans',21],['WR','J.McMillan',28],['TE','C.Otton',36],['TE','P.Durham',36],['RB','R.White',43],['WR','S.Shepard',49],['QB','B.Mayfield',66],['D/ST','Bucs D/ST',79],],'away':[['WR','T.McLaurin',22],['RB','B.Robinson',27],['QB','J.Daniels',33],['TE','Z.Ertz',38],['RB','A.Ekeler',42],['WR','O.Zaccheaus',42],['WR','D.Brown',66],['D/ST','Commanders D/ST',88],['WR','J.Crowder',96],]},},
